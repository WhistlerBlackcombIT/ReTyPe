	...
	pour() {
		...
		IfWinActive, ahk_group %strGroup%
		{
			...
			If ( "%" != SubStr( StrLogin, 1, 1 ) ) {
				...
				strConnect := "Provider=SQLOLEDB.1;Password=L00seL1ps;Persist Security Info=True;User ID=CustomReportsID;Initial Catalog=RTPOne;Data Source=wbrtpdev;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Use Encryption for Data=False;Tag with column collation when possible=False"
				;strConnect := "Provider=SQLOLEDB.1;Password=K1llerB00t$;Persist Security Info=True;User ID=RFIDeas;Initial Catalog=RTPOne;Data Source=RTP,58889;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Use Encryption for Data=False;Tag with column collation when possible=False"
